...
const ScheduleInspection = () => {
  ...
  const shops = [
    {
      name: "Pep Boys",
      address: "3 Walton St, Dorchester, MA",
      hours: "Mon - Fri  From 08:30 AM TO 06:00 PM",
    ...
    },
    {
      ...
      hours: "Mon - Sat  From 07:00 AM TO 07:00 PM",
      phone: "+1 123 456 7890",
      price: "$180 /Inspection",
    },
    {
      name: "Midas",
      address: "200 Main St, Los Angeles, CA",
      hours: "Mon - Sun  From 09:00 AM TO 05:00 PM",
      phone: "+1 987 654 3210",
      price: "$220 /Inspection",
    },
    {
      name: "Pep Boys",
      address: "3 Walton St, Dorchester, MA",
  ...
  const currentItems = shops.slice(
    ...
    <>
      {currentItems.map((shop, index) => (
        <div className="flex flex-col md:flex-row">
          <div
            key={index}
            className="grid w-full grid-cols-1 border mb-4 border-container rounded-md sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4"
          >
            <div className="p-4">
      ...
      <div>
        ...
        <button
          ...
          onClick={() =>
            setCurrentPage((oldPage) => Math.min(oldPage + 1, numPages))
          }
        >
          Next
        </button>
